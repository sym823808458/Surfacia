...
We welcome contributions to Surfacia! Please see our :doc:`contributing` guide for details on:
...
Surfacia is released under the MIT License. See :doc:`license` for full details.
...
Key publications that inform the theoretical foundations of Surfacia:

- Molecular surface analysis methodologies
- Quantum mechanical property calculations
- Machine learning applications in chemistry
- Surface-based molecular descriptors

**Applications**

Research studies utilizing Surfacia for:
